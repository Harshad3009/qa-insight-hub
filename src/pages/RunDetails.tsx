...
const mockRunDetails: RunDetailsType = {
    ...
    testCases: [
        ...
        {id: 2, testName: 'testUserLogout', className: 'AuthenticationTest', status: 'PASSED', duration: 0.8},
        {
            ...
            duration: 2.5,
            testFailure: {
                failureHash: "abcdef123",
                id: 1,
                message: 'Expected email to be sent but no email was received',
                stackTrace: 'at AuthenticationTest.testPasswordReset(AuthenticationTest.java:45)\nat sun.reflect.NativeMethodAccessorImpl.invoke0(Native Method)\nat org.junit.runners.model.FrameworkMethod.invokeExplosively(FrameworkMethod.java:47)'
            }
        },
        {id: 4, testName: 'testCheckoutFlow', className: 'E2ETest', status: 'PASSED', duration: 5.4},
        {
            id: 5,
            testName: 'testPaymentProcessing',
            className: 'PaymentTest',
            status: 'FAILED',
            duration: 3.2,
            testFailure: {
                failureHash: "ghijkl456",
                id: 1,
                message: 'Connection timeout to payment gateway',
                stackTrace: 'at PaymentTest.testPaymentProcessing(PaymentTest.java:78)\nat java.net.SocketInputStream.read(SocketInputStream.java:141)'
            }
        },
...
export default function RunDetails() {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            toast({
                title: "Delete Failed",
                description: "Failed to delete the test run. Please try again.",
                variant: "destructive"
            });
            setIsDeleting(false);
        }
                                            ...
                                            <div className="pl-7 pb-4 space-y-3">
                                                <div className="flex items-center gap-4 text-sm">
                                                    <Badge variant="outline"
                                                           className={getStatusBadgeClass(test.status)}>
                                                        {test.status}
                                                    </Badge>
                            ...
                            Duration: {test.duration.toFixed(2)}s
                                                ...
                                                {test.testFailure?.message && (
                                                    <div
                                                        ...
                                                        <p className="text-sm font-medium text-destructive mb-2">Error
                                                            Message</p>
                                                ...
                                                {test.testFailure?.stackTrace && (
                                                    <div className="p-3 rounded-lg bg-muted">
                                                        <p className="text-sm font-medium text-muted-foreground mb-2">Stack
                                                            Trace</p>
                                                        <pre
                                                            className="text-xs text-foreground overflow-x-auto font-mono">
                              {test.testFailure.stackTrace}
                            </pre>
                                                    </div>
                                                )}
                                        ...
                                        try {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    <p className="text-sm text-destructive">Failed to parse AI analysis
                                                        data</p>
                                                </div>
                                            );
                                        }
                                    ...
                                    return (
                                        <div className="space-y-6">
                                            ...
                                            <div
                                                ...
                                                <h3 className="text-sm font-semibold text-primary mb-2">Executive
                                                    Summary</h3>
                                            ...
                                            <div className="space-y-4">
                                                <h3 className="text-sm font-semibold text-foreground">Failure
                                                    Analysis</h3>
                                                {analysis.failureAnalysis?.map((item, index) => (
                                                    <div key={index}
                                                        ...
                                                        <div>
                                                            <p className="text-xs font-medium text-muted-foreground mb-1.5">Affected
                                                                Features</p>
                                                        ...
                                                        <div>
                                                            <p className="text-xs font-medium text-muted-foreground mb-1.5">Suggested
                                                                Fix</p>
                                            ...
                                            <div className="p-4 rounded-lg bg-warning/5 border border-warning/20">
                                                <h3 className="text-sm font-semibold text-warning mb-2">Flakiness
                                                    Check</h3>
